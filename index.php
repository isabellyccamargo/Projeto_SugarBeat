...
<body>
   ...
   <div class="produtos">
        ...
        <div class="grid">
            <?php
            // Verificamos se a variável $produtos existe e se é um array
            if (isset($produtos) && is_array($produtos)) {
                // Iteramos sobre os produtos que vieram do controlador
                foreach ($produtos as $produto) {
                    // Cada produto é um objeto da classe Produto, então usamos os métodos get
                    echo '<div class="card">';
